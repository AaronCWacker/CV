...
2. **Patient Check In** application called "[EasyCheck](https://easycheck-ca.optum.com/)" is an IVR/SMS conversational AI application that optimizes patient check in process EMR integrated health care appointment check in application for state of CA CDOs, serving over 400 locations with over 48k appts per month.
...
-------------|----------------------------|-----------------------------------
2023 - 2024  | Senior Principal Engineer, UnitedHealth (UNH)  |  Delivery of AI and Azure based healthcare apps including 1. 📊AI💡Service Now, 2. 🗣️AI🤝NPS, 3. GPT-4o📩Doc🗣️💬VoiceChat, 4. AI Claims, 5. AI PHI/PII Detection, 6. AI CI/CD for Product Delivery Acceleration, 7. SympleNote for MA, 8. SymptomSmart for WA, and 9.EasyCheck for CA.
