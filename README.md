...
|  Leader and Collaborator, Senior Principal Engineer |       Badges of Recognition - Optum / UHG, AI/ML Teacher and Inventor   |  High Performance Computing (HPC) Development Expert in Science/Medicine/Engineering using AI/ML|
|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|-------|
...
Inventor of multiple health care solutions with patents in field of AI/ML Programmatic Determinations with Decision Trees, Cognitive AI For Data Ordering, and Intelligent RAG Based Patient Education.  Hands on development leader for major healthcare apps in clinical areas of applied AI for Health Care, Assessment, NER of Clinical Terminology, Care Planning, Family Health, Intelligent Triage, Behavioral Health Prior Authorization, Medical Inpatient/Outpatient Charts and SMART/FHIR EMR Integrated Apps, Skilled Nursing Facility Recommendation, Provider specialist matchmaking, appointment making, mobile integration, and recommendation systems for Clinical business and technology.  Analytics Leader and Technology Owner for AI/ML Apps at scale and owner of MLRB/RUAI delivery as analytics leader on multiple projects and programs.  
...
1. **"[SympleNote & Symptom Smart](https://optumwa.com/innovations/)" - AI led medical interview and differential diagnosis** for triage, appointments and level of care recommendation.  Medical KB self care content educates patients, and integrates with Epic Mychart using SMART/FHIR and Azure microservices, serving three Care Delivery Organization (CDO) networks in WA, MA, and National West 12 state regions.
...
7. 📱 FullStack UI Mobile Dev: Mobile and web app development with ML integration, AI automation, MSGraph with Entra ID and msal, CICD automation with Azure DevOps, github actions, Docker, Terraform, REST APIs, AI chat, iOS, Android, Linux, Native android, webassembly, TS, React, GPT and M-LLMs (Multi-Modal) as agents.  DataDog and SauceLabs used for cross platform device tests and production video study for accessibility.
...
- **Research Interests**: Clinical, Medical and Behavioral Mixture of Experts (MoE), AGI and ML Agent Pipelines, Ambient IoT AI for Mobile, Behavioral Cognitive and Memory Personalization AI, Clinical Medical and Nursing AI, Genomics AI, DeepRL with MLAgents and Torch, Transformers, RLHF with Evaluation AI, Self Rewarding AI, GAN Gaming GAIL AR VR XR and Simulation AI, Graph Ontology KR KE AI, Languages and NLP AI, Quantum Compute GPU TPU NPU AI, Omni-modal Vision Image Document and Audio/Video AI, Instruct Data Engineering, GPT Claude Llama Deepseek, Human Feedback Systems and Datasets, and Deep Research Evaluation for Arxiv Paper informed invention moving from idea to working app automation and code interpretation and execution.
...
2020 - 2023  | Senior Principal Engineer, UnitedHealth (UNH)  |  Delivery of AI Assessment, AI Care Plan, Intelligent Data Recommender, Intelligent Nurse Triage, Ontology Manager, SympleNote for MA, SymptomSmart for WA, EasyCheck for CA.  2020-2023 MD Review predictor with place of service and IP understanding via full chart agent automation.
2017 - 2020  | Senior Principal Engineer, UnitedHealth (UNH)  |  Accredited as **Senior Principal Engineer (Technical Leader Career Path)**, Led development of 3 AI solutions for OP, and IP analytical solutions using Snomed, OMS, CPT4, ICD10, NPI clinical ontology and terminology based AI classification systems and recommenders.  2018 SNF recommendations reducing of readmits by 8%.  2019 approval automation for OP prior authorization, and clinical recommendation systems.  
...
2012 - 2016  | Director Apps Development, UnitedHealth (UNH)  |  Hired and managed **Team of 36 (12 Architects, 24 Pega LSA/CLSA and .NET developers) ** on large scale UHC Military and Veterans 4 year contract leading Clinical Apps Development.  
2012 - 2016  |                                                |  I led delivery and A&D $13M annual and $64M across enterprise leading .NET and PEGA architecture, and development and set our enterprise standards for Agile using Rally.   
...
1989 - 1994  | U of MN Bachelors of Independent Studies |  Computer Science, Psychology & Japanese pursuing AI, VR, and advanced technologies with learning, perception, and memory theory | Philanthropy Chairman and Scholarship Chairman of Chi/Psi, Japanese fluent.
