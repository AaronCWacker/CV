...
2. **Patient Check In** kiosk, mobile and conversational application called "[EasyCheck](https://easycheck-ca.optum.com/)" is an intelligent bot application with IVR and SMS capabilities to optimize patient check in process with EMR integrated health care appointment management and check in application for state of CA CDOs, serving over 400 locations with over 48k appts per month.
