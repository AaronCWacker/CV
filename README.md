...
7. 📱 FullStack UI Mobile Dev: Mobile and web app development with ML integration, AI automation, MSGraph with Entra ID and msal, CICD automation with Azure DevOps, github actions, Docker, Terraform, REST APIs, AI chat, iOS, Android, Linux, Native android, webassembly, TS, React, GPT and LLM as agents.
